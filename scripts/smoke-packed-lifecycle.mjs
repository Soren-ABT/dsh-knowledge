...
export function verifyUninstallOutcome(outcome, profilePackage) {
  ...
  if (bundlePresent) throw new Error('official DSH remove left dsh-knowledge in the profile bundle stack')
